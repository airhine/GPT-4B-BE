...
\`\`\`json
{
  ...
  "events": [
    {
      "title": "초기 투자 상담 미팅", // 🔗 관계 시작점
      // startDate, endDate는 자동 할당됨
      "category": "미팅", 
      "description": "시리즈A 투자 가능성 탐색, 기업 개요 프레젠테이션, 상호 소개",
      "location": "블루벤처스 본사 회의실 A", // 구체적 장소
      "participants": "박서연", // 참가자 이름 (단순 문자열)
      "memo": "관심 보임, 다음 실사자료 준비 필요. 기술보다 시장성 집중", // 관계 진전도
      "notification": 30,
      "isAllDay": false,
      "linked_card_ids": "1",
      "color": "#4285F4"
